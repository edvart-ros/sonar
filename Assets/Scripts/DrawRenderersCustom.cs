...
namespace UnityEngine.Rendering.HighDefinition
{
    ...
    /// </summary>
    [System.Serializable]
    public class MRTDrawRenderersCustomPass : CustomPass
    {
        /// <summary>
        /// HDRP Shader passes
        /// </summary>

        private RenderTargetIdentifier[] RTIds = new RenderTargetIdentifier[2];


        public RenderTexture rt1;
        public RenderTexture rt2;
        private RenderTargetIdentifier dRTId;
        ...
        protected override void Setup(ScriptableRenderContext renderContext, CommandBuffer cmd)
        {
            ...
            RTIds[0] = new RenderTargetIdentifier(rt1);
            RTIds[1] = new RenderTargetIdentifier(rt2);
            dRTId = new RenderTargetIdentifier(rt1.depthBuffer);
        ...
        protected override void Execute(CustomPassContext ctx)
        {
            ...
            ctx.cmd.SetRenderTarget(RTIds, dRTId);
